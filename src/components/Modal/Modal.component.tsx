...
const Modal = (props: ModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-70 flex items-center justify-center z-50">
      <div className="bg-white relative shadow-lg h-[85%] max-w-[30%] w-full">
        <div className="overflow-y-auto h-full pb-28 invisible-scrollbar">
          ...
          <div className="flex bg-background flex-col gap-5 p-6">
            <Checkbox />
            <Checkbox />
            <Checkbox />
          </div>
        ...
        <div className="flex flex-col gap-3 absolute backdrop-blur-sm p-5 w-full bottom-0 items-center justify-center">
          <div className="flex flex-row gap-8 items-center">
            <Button onClick={() => {}} disabled variant="icon" icon={<Icon.Minus />} />
            <p className="text-2xl font-semibold">1</p>
            <Button onClick={() => {}} variant="icon" icon={<Icon.Plus />} />
          </div>
